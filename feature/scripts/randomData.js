//var tags = [];
    ...
    var stName = ['DH-P1', 'DNHL-CUR', 'DH-P3', 'DNHL-VLT', 'MTR_OVERL', 'DH-P6', 'FREQ-SP', 'DNHL-SNSR-FAULT-CODE'];
    var uiLabel = ['Downhole P', 'Downhole P2', 'Downhole VLT', 'Motor Overlads', 'Frequency Setpoint', 'Downhole P6', 'Downhole P7', 'Downhole P8', 'Downhole P9', 'Downhole P10'];
